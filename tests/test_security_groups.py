...
def test_create_security_group(run_query: RunQueryFunc, getrandbits: Mock, mongo: Mock) -> None:
...
def test_describe_security_groups_empty_list(run_query: RunQueryFunc, mongo: Mock) -> None:
...
def test_describe_security_groups_no_tags(run_query: RunQueryFunc, mongo: Mock) -> None:
...
def test_describe_security_groups_with_tags(run_query: RunQueryFunc, mongo: Mock) -> None:
...
def test_describe_security_groups_with_ingress_rules(run_query: RunQueryFunc, mongo: Mock) -> None:
...
def test_authorize_security_group_ingress(run_query: RunQueryFunc, mongo: Mock) -> None:
